...
class SecondViewController: UIViewController {
    ...
    override func loadView() {
        ...
        imageView.frame = CGRect(x: 0, y: 0, width: pages*700, height: 750)
        ...
        let lb_main = MD_Label(title: lb_Main!)
        let lb_g1 = MD_Label(title: lb_game1!)
        let lb_g2 = MD_Label(title: lb_game2!)
        
        view.addSubview(scrollView)
        scrollView.addSubview(lb_main)
        scrollView.addSubview(lb_g1)
        scrollView.addSubview(lb_g2)
        ...
        NSLayoutConstraint.activate([
            ...
            lb_main.widthAnchor.constraint(equalToConstant: 575),
            ...
            lb_g1.centerXAnchor.constraint(equalTo: scrollView.centerXAnchor, constant: 700),
            lb_g1.centerYAnchor.constraint(equalTo: scrollView.centerYAnchor, constant: 150),
            lb_g1.widthAnchor.constraint(equalToConstant: 575),
            ...
            lb_g2.centerXAnchor.constraint(equalTo: scrollView.centerXAnchor, constant: 1400),
            lb_g2.centerYAnchor.constraint(equalTo: scrollView.centerYAnchor, constant: 150),
            lb_g2.widthAnchor.constraint(equalToConstant: 575),
...
class FirstViewController : UIViewController {
    ...
    override func loadView() {
        ...
        func Button(image: UIImage, tag: Int) -> UIButton{  
            ...
            button1.tag = tag
            button1.setTitle(" SEGA ", for: .normal)
        ...
        let segaTitle = Button(image: #imageLiteral(resourceName: "1__#$!@%!#__IMG_0084.JPG"), tag: 20)
        ...
        segaTitle.isUserInteractionEnabled = false
        
        view.addSubview(segaTitle)
        ...
        // Layout
        NSLayoutConstraint.activate([
            segaTitle.centerXAnchor.constraint(equalTo: view.centerXAnchor),
            segaTitle.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: -215),
            segaTitle.widthAnchor.constraint(equalToConstant: 700),
            segaTitle.heightAnchor.constraint(equalToConstant: 325),
            
            megaDrive.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: -160),
            megaDrive.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: -40),
            megaDrive.widthAnchor.constraint(equalToConstant: 300),
            megaDrive.heightAnchor.constraint(equalToConstant: 200),
            
            segaSaturn.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 170),
            segaSaturn.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: -40),
            segaSaturn.widthAnchor.constraint(equalToConstant: 300),
            segaSaturn.heightAnchor.constraint(equalToConstant: 200),
            
            dreamCast.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: -160),
            dreamCast.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 190),
            dreamCast.widthAnchor.constraint(equalToConstant: 300),
            dreamCast.heightAnchor.constraint(equalToConstant: 200),
            masterSystem.centerXAnchor.constraint(equalTo: view.centerXAnchor, constant: 170),
            masterSystem.centerYAnchor.constraint(equalTo: view.centerYAnchor, constant: 190),
